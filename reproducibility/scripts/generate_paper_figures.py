...
import os as _os
# Resolve data root: TOURMART_ROOT env var, or two levels up from this script.
_SCRIPT_DIR = Path(_os.path.dirname(_os.path.abspath(__file__)))
_REPO_ROOT = Path(_os.environ.get("TOURMART_ROOT", str(_SCRIPT_DIR.parent.parent.parent)))
